...
(function ($) {
  ...
  function runXhrRequest(url, data, options) {
    ...
    xhrRequest.onreadystatechange = function () {
      ...
      if (
        (xhrRequest.status < 200 || xhrRequest.status >= 300) &&
        xhrRequest.status !== 304
      ) {
        options.error();
        xhrRequest = null;
        return;
                  ...
                  runXhrRequest(uploadPluginOptions.serverPath, data, {
                    ...
                    success: function (data) {
                      ...
                      if (
                        !getDeep(
                          data,
                          uploadPluginOptions.statusPropertyName.split("."),
                        )
                      ) {
                      ...
                      var url = getDeep(
                        data,
                        uploadPluginOptions.urlPropertyName.split("."),
                      );
                      ...
                      if (
                        uploadPluginOptions.imageWidthModalEdit &&
