...
!(function (e, t) {
  ...
  function u(e, t) {
    ...
    if (e) {
      for (
        i = (e = e.split("/")).length - 1,
          _.nodeIdCompat && k.test(e[i]) && (e[i] = e[i].replace(k, "")),
          "." === e[0].charAt(0) &&
            f &&
  ...
  (p = {}),
    ...
    (r = function (e, t, n, s) {
      ...
      if (((u = S((s = s || e))), "undefined" == h || "function" == h)) {
        ...
        (i = n ? n.apply(p[e], c) : void 0),
          e &&
            (a && a.exports !== f && a.exports !== p[e]
              ? (p[e] = a.exports)
              : (i === f && d) || (p[e] = i));
      } else e && (p[e] = n);
    }),
    ...
    n("component/helper", ["./models"], function (u) {
      ...
      return (
        ...
        (n.getClass = function (e) {
          ...
          if (d[t]) return d[t];
          for (
            var n = e.split(""), s = [], a = n.length, r = 0, i = 0;
            r < a;
            r++
          ) {
            var o = n[r];
            !0 === c.test(o) &&
              ((s[i++] = "-"), (o = o.toString().toLowerCase())),
              (s[i++] = o);
          }
          var l = s.join("");
          return (d[t] = l);
        ...
        (n.getSubClass = function (e) {
          ...
          return (
            s[e] || (s[e] = n.getClass(n.format("{0}{1}", u.name, e))), s[e]
          );
        }),
        n
      );
    ...
    (l = function () {
      ...
      function w(e) {
        y(this, e),
          ...
          !1 === t && ((t = !0), _.updateOffset(this), (t = !1));
      }
      function M(e) {
      ...
      function n(a, r) {
        ...
        return f(function () {
          if (
            (null != _.deprecationHandler && _.deprecationHandler(null, a), i)
          ) {
      ...
      function Ye(t, n) {
        return function (e) {
          return null != e
            ? (Oe(this, t, e), _.updateOffset(this, n), this)
            : Ce(this, t);
        };
      }
      function Ce(e, t) {
      ...
      function Ae(e) {
        return null != e
          ? (Le(this, e), _.updateOffset(this, !0), this)
          : Ce(this, "Month");
      }
      var He = ie,
        Fe = ie;
      function Re() {
        ...
        for (s.sort(e), a.sort(e), r.sort(e), t = 0; t < 12; t++)
          (s[t] = ue(s[t])), (a[t] = ue(a[t]));
      ...
      function Ge(e, t, n) {
        ...
        return (
          i < 1
            ? (s = i + Ve((a = e.year() - 1), t, n))
            : i > Ve(e.year(), t, n)
              ? ((s = i - Ve(e.year(), t, n)), (a = e.year() + 1))
              : ((a = e.year()), (s = i)),
          { week: s, year: a }
        );
      }
      ...
      function Be() {
        ...
        for (t = 0; t < 7; t++)
          (n = m([2e3, 1]).day(t)),
            ...
            u.push(a),
            u.push(r);
        for (i.sort(e), o.sort(e), l.sort(e), u.sort(e), t = 0; t < 7; t++)
          (o[t] = ue(o[t])), (l[t] = ue(l[t])), (u[t] = ue(u[t]));
      ...
      V("H", ["HH", 2], 0, "hour"),
        ...
        V("hmmss", 0, 0, function () {
          return (
            "" + Qe.apply(this) + R(this.minutes(), 2) + R(this.seconds(), 2)
          );
        }),
        V("Hmm", 0, 0, function () {
        ...
        return (
          n &&
            ...
            ((t =
              n[me] < 0 || 11 < n[me]
                ? me
                : n[ge] < 1 || n[ge] > Te(n[fe], n[me])
                  ? ge
                  : n[pe] < 0 ||
                      24 < n[pe] ||
                      (24 === n[pe] &&
                        (0 !== n[ye] || 0 !== n[_e] || 0 !== n[ve]))
                    ? pe
                    : n[ye] < 0 || 59 < n[ye]
                      ? ye
                      : n[_e] < 0 || 59 < n[_e]
                        ...
                        : n[ve] < 0 || 999 < n[ve]
                          ? ve
                          : -1),
            k(e)._overflowDayOfYear && (t < fe || ge < t) && (t = ge),
            k(e)._overflowWeeks && -1 === t && (t = ke),
            k(e)._overflowWeekday && -1 === t && (t = we),
            (k(e).overflow = t)),
          e
        );
      }
        ...
        if (!e._d) {
          ...
          for (
            o = e,
              ...
              e._w &&
                ...
                (function (e) {
                  ...
                  if (null != (t = e._w).GG || null != t.W || null != t.E)
                    (r = 1),
                      (i = 4),
                      (n = ct(t.GG, e._a[fe], Ge(Yt(), 1, 4).year)),
                      (s = ct(t.W, 1)),
                      ((a = ct(t.E, 1)) < 1 || 7 < a) && (l = !0);
                  else {
                    (r = e._locale._week.dow), (i = e._locale._week.doy);
                    var u = Ge(Yt(), r, i);
                    (n = ct(t.gg, e._a[fe], u.year)),
                      (s = ct(t.w, u.week)),
                      null != t.d
                        ? ((a = t.d) < 0 || 6 < a) && (l = !0)
                        : null != t.e
                          ? ((a = t.e + r), (t.e < 0 || 6 < t.e) && (l = !0))
                          : (a = r);
                  }
                  s < 1 || s > Ve(n, r, i)
              ...
              null != e._dayOfYear &&
                ((r = ct(e._a[fe], s[fe])),
                (e._dayOfYear > Me(r) || 0 === e._dayOfYear) &&
                  (k(e)._overflowDayOfYear = !0),
                (n = je(r, 0, e._dayOfYear)),
          ...
          24 === e._a[pe] &&
            ...
            (e._d = (
              e._useUTC
                ? je
                : function (e, t, n, s, a, r, i) {
                    var o;
                    return (
                      e < 100 && 0 <= e
                        ? ((o = new Date(e + 400, t, n, s, a, r, i)),
                          isFinite(o.getFullYear()) && o.setFullYear(e))
                        : (o = new Date(e, t, n, s, a, r, i)),
                      o
                    );
                  }
            ).apply(null, i)),
        ...
        if (a) {
          ...
          if (
            ...
            (t = a[1]) &&
              ...
              ((k(s).weekdayMismatch = !0), !(s._isValid = !1)))
          )
            return;
          (e._a = r),
        ...
        if (e._f !== _.ISO_8601)
          if (e._f !== _.RFC_2822) {
            ...
            var t,
              ...
              c = 0;
            for (
              s = I(e._f, e._locale).match(j) || [], t = 0;
              t < s.length;
              t++
            )
              (a = s[t]),
                (n = (u.match(
                  ...
                  (0 < (r = u.substr(0, u.indexOf(n))).length &&
                    k(e).unusedInput.push(r),
                  (u = u.slice(u.indexOf(n) + n.length)),
                  (c += n.length)),
                G[a]
                  ? (n ? (k(e).empty = !1) : k(e).unusedTokens.push(a),
                    (i = a),
                    (l = e),
                    null != (o = n) && v(de, i) && de[i](o, l._a, l, i))
                  : e._strict && !n && k(e).unusedTokens.push(a);
            (k(e).charsLeftOver = d - c),
                                ...
                                null === (a = _t.exec(s._i))
                                  ? (vt(s),
                                    !1 === s._isValid &&
                                      ...
                                      !1 === s._isValid &&
                                        (delete s._isValid,
                                        _.createFromInputFallback(s))))
                                  : (s._d = new Date(+a[1])))
                              : o(n)
                                ? ((t._a = h(n.slice(0), function (e) {
      ...
      function Wt(e) {
        ...
        (this._isValid = (function (e) {
          for (var t in e)
            if (-1 === be.call(xt, t) || (null != e[t] && isNaN(e[t])))
              return !1;
      ...
      function Rt(e, t) {
        ...
        return t._isUTC
          ? ((n = t.clone()),
            (s = (M(e) || c(e) ? e.valueOf() : Yt(e).valueOf()) - n.valueOf()),
                ...
                : (u = Gt.exec(e))
                  ...
                  : null == l
                    ...
                    : "object" == typeof l &&
                      ...
                      (l.M = a.months)),
          (s = new Wt(l)),
          Pt(e) && v(e, "_locale") && (s._locale = e._locale),
          s
        );
      }
      function Et(e, t) {
        ...
        return function (e, t) {
          ...
          return (
            null === t ||
              ...
              (e = t),
              (t = n)),
            Jt(this, Vt((e = "string" == typeof e ? +e : e), t), s),
            this
          );
        };
      }
      function Jt(e, t, n, s) {
        ...
        e.isValid() &&
          ((s = null == s || s),
          i && Le(e, Ce(e, "Month") + i * n),
          r && Oe(e, "Date", Ce(e, "Date") + r * n),
          a && e._d.setTime(e._d.valueOf() + a * n),
          s && _.updateOffset(e, r || i));
      }
      (Vt.fn = Wt.prototype),
        (Vt.invalid = function () {
          return Vt(NaN);
      ...
      V(0, ["gg", 2], 0, function () {
        ...
        le("GGGGG", te, $),
        le("ggggg", te, $),
        he(["gggg", "ggggg", "GGGG", "GGGGG"], function (e, t, n, s) {
          t[s.substr(0, 2)] = b(e);
        }),
      ...
      (hn.add = Zt),
        ...
        (hn.diff = function (e, t, n) {
          ...
          switch (
            ((a = 6e4 * (s.utcOffset() - this.utcOffset())), (t = L(t)))
          ) {
            case "year":
              r = $t(this, s) / 12;
              break;
        ...
        (hn.from = function (e, t) {
          return this.isValid() && ((M(e) && e.isValid()) || Yt(e).isValid())
        ...
        (hn.hour = hn.hours = tt),
        (hn.minute = hn.minutes = on),
        (hn.second = hn.seconds = un),
        ...
        (hn.dates = n("dates accessor is deprecated. Use date instead.", rn)),
        (hn.months = n("months accessor is deprecated. Use month instead", Ae)),
        (hn.years = n("years accessor is deprecated. Use year instead", Se)),
        (hn.zone = n(
      ...
      (mn.calendar = function (e, t, n) {
        ...
        (mn.months = function (e, t) {
          return e
            ? o(this._months)
              ...
              : this._months[
                  (this._months.isFormat || xe).test(t)
                    ? "format"
                    : "standalone"
                ][e.month()]
            : o(this._months)
        ...
        (mn.monthsShort = function (e, t) {
          return e
            ? o(this._monthsShort)
              ...
              : this._monthsShort[xe.test(t) ? "format" : "standalone"][
                  e.month()
                ]
            : o(this._monthsShort)
              ? this._monthsShort
        ...
        (mn.monthsParse = function (e, t, n) {
          ...
          if (this._monthsParseExact)
            return function (e, t, n) {
              ...
              return n
                ? "MMM" === t
                  ? -1 !== (a = be.call(this._shortMonthsParse, i))
                    ? a
                    : null
                  : -1 !== (a = be.call(this._longMonthsParse, i))
                    ? a
                    : null
                : "MMM" === t
                  ? -1 !== (a = be.call(this._shortMonthsParse, i))
        ...
        (mn.monthsRegex = function (e) {
          return this._monthsParseExact
            ? (v(this, "_monthsRegex") || Re.call(this),
              e ? this._monthsStrictRegex : this._monthsRegex)
            : (v(this, "_monthsRegex") || (this._monthsRegex = Fe),
        ...
        (mn.monthsShortRegex = function (e) {
          return this._monthsParseExact
            ...
            : (v(this, "_monthsShortRegex") || (this._monthsShortRegex = He),
        ...
        (mn.weekdaysParse = function (e, t, n) {
          ...
          if (this._weekdaysParseExact)
            return function (e, t, n) {
              ...
              return n
                ? "dddd" === t
                  ? -1 !== (a = be.call(this._weekdaysParse, i))
                    ? a
                    : null
                  : "ddd" === t
                    ? -1 !== (a = be.call(this._shortWeekdaysParse, i))
                      ? a
                      : null
                    : -1 !== (a = be.call(this._minWeekdaysParse, i))
                      ? a
                      : null
                : "dddd" === t
                  ? -1 !== (a = be.call(this._weekdaysParse, i))
        ...
        (mn.weekdaysRegex = function (e) {
          return this._weekdaysParseExact
            ? (v(this, "_weekdaysRegex") || Be.call(this),
              e ? this._weekdaysStrictRegex : this._weekdaysRegex)
            : (v(this, "_weekdaysRegex") || (this._weekdaysRegex = Ze),
        ...
        (mn.weekdaysMinRegex = function (e) {
          return this._weekdaysParseExact
            ...
            : (v(this, "_weekdaysMinRegex") || (this._weekdaysMinRegex = $e),
        ...
        (_.updateLocale = function (e, t) {
          if (null != t) {
            var n,
              s,
              a = nt;
            null != (s = it(e)) && (a = s._config),
              ((n = new x((t = T(a, t)))).parentLocale = st[e]),
              (st[e] = n),
              ot(e);
          } else
            null != st[e] &&
    ...
    "object" == typeof exports && "undefined" != typeof module
      ...
      : "function" == typeof n && n.amd
        ? n("moment", l)
        : (o.moment = l()),
    n("manager/index", ["../component/helper", "moment"], function (a, r) {
      function e(e) {
    ...
    n("configures/i18n", [], function () {
      return {
        ...
        controls: {
          ...
          ca: { ok: "Confirmar", cancel: "Cancel·lar" },
        },
      };
    }),
        ...
        return function (e) {
          ...
          (t.settings = i.extend(!0, {}, a, e)),
            ...
            "light" !== t.settings.theme &&
              -1 ===
                i.inArray(t.settings.theme, s.preference.supports.themes) &&
        ...
        return function (e) {
          ...
          (b.settings = {}),
            ...
            (b.global = {
              ...
              calendarButtonsHtml: H.format(
                '<div class="{0}-group">                                            <a href="#" class="{0} {0}-cancel">{1}</a>                                            <a href="#" class="{0} {0}-apply">{2}</a>                                          </div>',
                A.button,
                b.settings.controls.cancel,
                b.settings.controls.ok,
              ),
              calendarScheduleContainerHtml: H.format(
                '<div class="{0}-schedule-container"></div>',
                A.button,
              ),
              calendarSchedulePinHtml: H.format(
          ...
          var S = H.getSubClass("unitRange"),
            ...
            T = [
              H.getSubClass("unitFirstActive"),
              H.getSubClass("unitSecondActive"),
            ],
          ...
          return b.each(function () {
            var v = j(this),
              k = {
                ...
                calendarWrapperHtml: H.format(
                  '<div class="{0}"></div>',
                  H.getSubClass("wrapper"),
                ),
                calendarWrapperOverlayHtml: H.format(
                  '<div class="{0}"></div>',
                  H.getSubClass("wrapperOverlay"),
                ),
                context: b,
              },
              w = v;
            !0 === b.settings.initialize &&
              (k.initialize = k.current[0] = k.dateManager.date.clone()),
              (this.local = k),
              !0 === b.settings.reverse
                ? k.calendar.addClass(H.getSubClass("reverse"))
                : k.calendar.addClass(H.getSubClass("default"));
            for (
              var e = b.settings.week;
              e < b.settings.weeks.length + b.settings.week;
              e++
            ) {
                ...
                (t = t.toUpperCase()),
                  j(
                    H.format(
                      ...
                      H.getSubClass("week"),
                      t,
                      R.languages.weeks.en[
                        e % R.languages.weeks.en.length
                      ].toLowerCase(),
                    ),
                  ).appendTo(k.calendar.find("." + A.header));
            }
            if (
              (!0 === b.settings.buttons &&
                (P = j(b.global.calendarButtonsHtml)).appendTo(k.calendar),
              !0 === k.input || !0 === b.settings.modal)
            ) {
              var n,
                ...
                v
                  .bind("click", function (e) {
                    e.preventDefault(),
                      ...
                      (n = j("." + H.getSubClass("wrapperOverlay"))).length <
                        1 &&
                        (n = j(k.calendarWrapperOverlayHtml)).appendTo("body"),
                      n
                        .unbind("click." + H.getClass(F.name))
                        .bind("click." + H.getClass(F.name), function (e) {
                          e.stopPropagation(),
                            w.trigger("cancel." + H.getClass(F.name));
                        }),
                      !1 === w.parent().is("body") && w.appendTo("body"),
                      w.show(),
                      n.show(),
                      r
                        .unbind("resize." + H.getClass(F.name))
                        .bind("resize." + H.getClass(F.name), function () {
                          w.css({
                            marginLeft: -w.outerWidth() / 2,
                            marginTop: -w.outerHeight() / 2,
                          });
                        })
                        .triggerHandler("resize." + H.getClass(F.name)),
                      v[F.name]("set", v.val()),
                      setTimeout(function () {
            ...
            function M() {
              ...
              for (
                var i = n.format("YYYY-MM-DD"), o = s.format("YYYY-MM-DD");
                n.format("YYYY-MM-DD") <= s.format("YYYY-MM-DD");
                n.add(1, "days")
              ) {
            ...
            (k.renderer = function () {
              if (
                (k.calendar.appendTo(w.empty()),
                k.calendar.find("." + A.top + "-year").text(k.dateManager.year),
                k.calendar
                  .find("." + A.top + "-month")
                  .text(b.settings.monthsLong[k.dateManager.month - 1]),
                k.calendar
                  .find(H.format(".{0}-prev .{0}-value", A.top))
                  .text(
                    b.settings.months[
                ...
                k.calendar
                  .find(H.format(".{0}-next .{0}-value", A.top))
                  .text(
                    b.settings.months[
                      k.dateManager.nextMonth - 1
                    ].toUpperCase(),
                  ),
                !0 === b.settings.buttons && P)
              ) {
                var a = v;
                P.find("." + A.button).bind("click", function (e) {
                  ...
                  if (t.hasClass(A.button + "-apply")) {
                    ...
                    if (!0 === b.settings.toggle)
                      ...
                      var s = [];
                      null !== k.current[0] &&
                        s.push(k.current[0].format(b.settings.format)),
                        null !== k.current[1] &&
                          s.push(k.current[1].format(b.settings.format)),
                        (n = s.join(" ~ "));
                    } else
                      n =
                        null === k.current[0]
                          ? ""
                          : N(k.current[0]).format(b.settings.format);
                    !0 === k.input && a.val(n).triggerHandler("change"),
                      "function" == typeof b.settings.apply &&
                        b.settings.apply.call(k.calendar, k.current, k),
                      w.triggerHandler("apply." + H.getClass(F.name));
              ...
              for (
                var d = [],
                  ...
                  h =
                    null === b.settings.minDate ? null : N(b.settings.minDate),
                  f =
                    null === b.settings.maxDate ? null : N(b.settings.maxDate),
                  i = 0;
                i < s;
                i++
              ) {
                var o = j(
                  H.format(
                    '<div class="{0} {0}-{1}"></div>',
                    H.getSubClass("unit"),
                    R.languages.weeks.en[i].toLowerCase(),
                  ),
                );
                d.push(o);
              }
              function l(e) {
                var t = L.Convert(k.dateManager.year, k.dateManager.month, e),
                  ...
                  s = j(
                    H.format(
                      ...
                      t.format("YYYY-MM-DD"),
                      e,
                      R.languages.weeks.en[t.weekday()].toLowerCase(),
                    ),
                  );
                if (0 < b.settings.enabledDates.length)
                  -1 === j.inArray(n, b.settings.enabledDates) &&
                    s.addClass(H.getSubClass("unitDisabled"));
                else if (
                  0 < b.settings.disabledWeekdays.length &&
                  -1 !== j.inArray(t.weekday(), b.settings.disabledWeekdays)
                )
                  s.addClass(H.getSubClass("unitDisabled")).addClass(
                    H.getSubClass("unitDisabledWeekdays"),
                  );
                else if (
                  (null !== h && 0 < h.diff(t)) ||
                  (null !== f && f.diff(t) < 0)
                  ...
                  s.addClass(H.getSubClass("unitDisabled")).addClass(
                    H.getSubClass("unitDisabledRange"),
                  );
                else if (-1 !== j.inArray(n, b.settings.disabledDates))
                  s.addClass(H.getSubClass("unitDisabled"));
                else if (0 < b.settings.disabledRanges.length)
                  for (
                    var a = b.settings.disabledRanges.length, r = 0;
                    r < a;
                    r++
                  ) {
                    ...
                    if (0 <= t.diff(N(i[0])) && t.diff(N(i[1])) <= 0) {
                      s.addClass(H.getSubClass("unitDisabled"))
                        .addClass(H.getSubClass("unitDisabledRange"))
                        .addClass(H.getSubClass("unitDisabledMultipleRange"));
                      break;
                    }
                  }
                if (
                  0 < b.settings.schedules.length &&
                  "object" === U(b.settings.scheduleOptions) &&
                  "object" === U(b.settings.scheduleOptions.colors)
                ) {
                    ...
                    u.appendTo(s),
                      l.map(function (e, t) {
                        if (b.settings.scheduleOptions.colors[e]) {
                          ...
                          j(
                            H.format(b.global.calendarSchedulePinHtml, e, n),
                          ).appendTo(u);
                        }
                      });
                  }
                ...
                !0 === b.settings.toggle
                  ? -1 !== j.inArray(n, k.storage.activeDates) &&
                    0 < k.storage.activeDates.length
                    ? s.addClass(x)
                    : s.addClass(W)
                  : !1 === s.hasClass(H.getSubClass("unitDisabled")) &&
                    (!0 === b.settings.multiple
                      ? (c[0] && n === c[0] && s.addClass(O).addClass(T[0]),
                        c[1] && n === c[1] && s.addClass(O).addClass(T[1]))
                      : c[0] &&
                        n === c[0] &&
                        -1 === j.inArray(c[0], b.settings.disabledDates) &&
                        (b.settings.enabledDates.length < 1 ||
                          -1 !== j.inArray(c[0], b.settings.enabledDates)) &&
                        s.addClass(O).addClass(T[0])),
                  d.push(s);
                var g = v;
                s.bind("click", function (e) {
                  ...
                  if (t.hasClass(H.getSubClass("unitDisabled"))) a = !0;
                    ...
                    !0 === k.input &&
                    !1 === b.settings.multiple &&
                    !1 === b.settings.buttons
                  )
                    g.val(N(n).format(b.settings.format)),
                      w.triggerHandler("apply." + H.getClass(F.name));
                  else if (
                    null !== k.initialize &&
                    ...
                    if (!0 === b.settings.toggle) {
                      ...
                      if (((k.current[s] = N(n)), r.length < 1))
                        k.storage.activeDates.push(n),
                          t.addClass(x).removeClass(W);
                      else {
                        for (
                          var i = 0, o = 0;
                          o < k.storage.activeDates.length;
                          o++
                        ) {
                        ...
                        k.storage.activeDates.splice(i, 1),
                          t.removeClass(x).addClass(W);
                      }
                    } else if (
                      !0 === t.hasClass(O) &&
                      !1 === b.settings.pickWeeks
                    )
                      !0 === b.settings.multiple &&
                        (t.hasClass(T[0]) ? (s = 0) : T[1] && (s = 1)),
                        t.removeClass(O).removeClass(T[s]),
                        (k.current[s] = null);
                    else {
                          ...
                          (!1 ===
                            (function (e, t) {
                              ...
                              for (var s in b.settings.disabledDates)
                                if (
                                  ((n = N(b.settings.disabledDates[s])),
                                  D(e, t, n))
                                )
                                  return !1;
                              ...
                              for (
                                var c = 0, h = 0;
                                c < b.settings.disabledWeekdays.length && h < 7;
                                c++
                              ) {
                                h++;
                            ...
                            k.calendar
                              ...
                              .removeClass(T[0])
                              .removeClass(T[1])),
                          !0 === k.input && !1 === b.settings.buttons)
                        ) {
                          var h = [];
                          null !== k.current[0] &&
                            h.push(k.current[0].format(b.settings.format)),
                            null !== k.current[1] &&
                              h.push(k.current[1].format(b.settings.format)),
                            t.val(h.join(", ")),
                            w.trigger("apply." + H.getClass(F.name));
                        }
                      }
                    }
                    !0 === b.settings.multiple &&
                      ...
                      M.call()),
                      0 < b.settings.schedules.length &&
                        (k.storage.schedules = b.settings.schedules.filter(
                          function (e) {
                            return e.date === n;
                          },
                        ));
                  ...
                  function f(e) {
                    k.date.all.push(e),
                      !(function (e) {
                        if (-1 !== b.settings.disabledDates.indexOf(e))
                          return !1;
                  ...
                  !1 === a &&
                    ...
                    "function" == typeof b.settings.select &&
                      b.settings.select.call(t, k.current, k)),
                    "function" == typeof b.settings.click &&
                      b.settings.click.call(t, e, k);
                });
              }
              for (
                var u = k.dateManager.firstDay;
              ...
              for (var p = null, y = 0; y < d.length; y++) {
                var _ = d[y];
                (y % b.settings.weeks.length == 0 || y + 1 >= d.length) &&
                  (null !== p && p.appendTo(e),
                  y + 1 < d.length &&
                    (p = j(
                      H.format('<div class="{0}"></div>', H.getSubClass("row")),
                    ))),
                  p.append(_);
              }
              k.calendar.find("." + A.top + "-nav").bind("click", function (e) {
                ...
                var t = j(this),
                  n = "unkown";
                t.hasClass(A.top + "-prev")
                  ? ((n = "prev"),
                    (k.dateManager = new L(
                      k.dateManager.date.clone().add(-1, "months"),
                    )))
                  : t.hasClass(A.top + "-next") &&
                    ((n = "next"),
                    (k.dateManager = new L(
                      k.dateManager.date.clone().add(1, "months"),
                    ))),
                  "function" == typeof b.settings.page &&
                    b.settings.page.call(
                      t,
                      {
                        type: n,
              ...
              k.renderer.call(),
              (v[0][F.name] = k),
              "function" == typeof b.settings.init &&
                b.settings.init.call(v, k);
          });
        };
      },
    ),
    n(
      ...
      function (a, e, r) {
        return function (e) {
          var s = r.extend(
            { language: a.language, languages: {}, week: null, format: null },
            e,
          );
          if (
            ((a.language = s.language), 0 < Object.keys(s.languages).length)
          ) {
            function t(t) {
              var n = s.languages[t];
              if (
              ...
              -1 === a.languages.supports.indexOf(t) &&
                a.languages.supports.push(t),
                ["weeks", "monthsLong", "months", "controls"].map(function (e) {
                  a.languages[e][t] &&
                    ...
                    (a.languages[e][t] =
                      n[e] || a.languages[e][t.defaultLanguage]);
                });
            }
    ...
    n("methods/select", ["../component/helper", "jquery"], function (s, a) {
      return function (n) {
        this.each(function () {
          ...
          a(this)
            .find(s.format('.{0}[data-date="{1}"]', s.getSubClass("unit"), t))
          ...
          if (e) {
            ...
            this.each(function () {
              var e = r(this)[0][l.name],
                t = e.context,
                n = [
                  a[0] ? i(a[0], t.settings.format) : null,
                  a[1] ? i(a[1], t.settings.format) : null,
                ];
              if (
                ((e.dateManager = new o(n[0])),
                !0 === t.settings.pickWeeks && n[0])
              ) {
                var s = n[0];
                (n[0] = s.clone().startOf("week")),
                  (n[1] = s.clone().endOf("week"));
              }
              !0 === t.settings.toggle
                ? (e.storage.activeDates = a)
                : (e.current = n),
                e.renderer.call();
            });
          }
    ...
    n(
      ...
      function (e, t, n, s, a) {
        return { init: e, configure: t, setting: n, select: s, set: a };
      },
    ),
  ...
  var c = Zn("main"),
    ...
    Y = Zn("jquery"),
    C = window || {};
  for (var O in ((C.moment = Zn("moment")),
  (Y.fn[h.name] = function (e) {
    return c.apply(
      c,
