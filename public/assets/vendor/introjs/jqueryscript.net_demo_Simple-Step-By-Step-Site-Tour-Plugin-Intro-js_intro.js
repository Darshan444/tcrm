...
(function (root, factory) {
    ...
    switch (currentTooltipPosition) {
      case "top":
        ...
        tooltipLayer.style.top =
          "-" + (tooltipLayerPosition.height + 10) + "px";
        arrowLayer.className = "introjs-arrow bottom";
        break;
      case "right":
        tooltipLayer.style.right =
          "-" + (tooltipLayerPosition.width + 10) + "px";
  ...
  function _showElement(targetElement) {
    ...
    if (oldHelperLayer != null) {
      var oldHelperNumberLayer = oldHelperLayer.querySelector(
      ...
      oldHelperLayer.setAttribute(
        "style",
        "width: " +
          (elementPosition.width + 10) +
          "px; " +
          "height:" +
          (elementPosition.height + 10) +
          "px; " +
          "top:" +
      ...
      var tooltipButtonsLayer = tooltipLayer.querySelector(
    ...
    if (targetElement.currentStyle) {
      ...
      //Firefox
      currentElementPosition = document.defaultView
